...
export SCOTCHHOME="${VENDOR_HOME}/scotch"

export PATH="${HDF5HOME}/bin:${MEDHOME}/bin:${METISHOME}/bin:${PATH}"
export LD_LIBRARY_PATH="${HOMETEL}/builds/${USETELCFG}/wrap_api/lib:${HDF5HOME}/lib:${MEDHOME}/lib:$SCOTCHHOME/lib:${LD_LIBRARY_PATH}"
